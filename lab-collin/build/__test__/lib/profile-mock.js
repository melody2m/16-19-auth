...
var pCreateProfileMock = function pCreateProfileMock() {
  ...
  return (0, _accountMock.pCreateAccountMock)().then(function (accountSetMock) {
    ...
    return new _profile2.default({
      catchphrase: _faker2.default.lorem.words(10),
      visage: _faker2.default.random.image(),
      pseudonym: _faker2.default.name.lastName(),
      persona: _faker2.default.name.firstName(),
